...
export class FrontendStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: FrontendStackProps) {
    ...
    diversResource.addMethod(
      "GET",
      new apigateway.LambdaIntegration(props.backendStack.getAllDiversFunction)
    );

    // GET /api/divers/{diverId} - Get diver profile
    const diverResource = diversResource.addResource("{diverId}");
    diverResource.addMethod(
      "GET",
      new apigateway.LambdaIntegration(
        props.backendStack.getDiverProfileFunction
      )
    );
    ...
    trainingResource.addMethod(
      "GET",
      new apigateway.LambdaIntegration(
        props.backendStack.getDiverTrainingFunction
      )
    );
    ...
    photoResource.addMethod(
      "GET",
      new apigateway.LambdaIntegration(
        props.backendStack.getTrainingPhotoFunction
      )
    );
