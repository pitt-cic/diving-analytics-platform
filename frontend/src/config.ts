...
export const config = {
  // API Configuration
  apiEndpoint: process.env.REACT_APP_API_ENDPOINT || 'https://api.example.com', // Will be replaced with actual API endpoint
  ...
  aws: {
    ...
    graphqlApiUrl: process.env.REACT_APP_GRAPHQL_API_URL || 'https://example.com/graphql',
  ...
  features: {
    ...
    diveMeetsIntegration: process.env.REACT_APP_FEATURE_DIVEMEETS_INTEGRATION === 'true',
